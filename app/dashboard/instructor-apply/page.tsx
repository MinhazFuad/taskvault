        ...
        <section className="bg-slate-800/60 border border-slate-700 rounded-2xl p-6 space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center text-sm">
              ...
              <span className={`font-bold text-sm flex items-center gap-0.5 ${eligibility?.meetsRating ? 'text-emerald-400' : 'text-slate-400'}`}>
                {(eligibility?.ratingCount || 0) > 0
                  ? <>{(eligibility?.rating || 0).toFixed(1)}<svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg></>
                  : 'No ratings yet'
                } / 4.8<svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
              </span>
            </div>
            <div className="h-2.5 bg-slate-900 rounded-full overflow-hidden">
              <div
            ...
            {!eligibility?.meetsRating && (
              <p className="text-[11px] text-slate-500">
                {(eligibility?.ratingCount || 0) === 0
                  ...
                  : <>Raise your average by {(4.8 - (eligibility?.rating || 0)).toFixed(2)}<svg className="w-3 h-3 fill-current inline-block align-middle" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg> by delivering high-quality work.</>
                }
              </p>
            )}
          </div>
