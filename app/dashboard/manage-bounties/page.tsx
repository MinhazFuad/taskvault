              ...
              <div className="space-y-1.5">
                ...
                {isDateInvalid && (
                  <p className="text-xs text-red-400 mt-1.5 animate-in fade-in slide-in-from-top-1">
                    <span className="flex items-center gap-1"><svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/></svg> Please choose a valid date (today or in the future).</span>
                  </p>
                )}
              </div>
            </div>
