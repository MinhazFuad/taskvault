  ...
  try {
    ...
    const [userRows]: any = await pool.execute(
      `SELECT U.Full_Name, U.Email, U.Username, U.Role, U.Profile_Picture, U.Banner_Image, U.Bio,
              U.Headline, U.Location, U.LinkedIn_URL, U.GitHub_URL, U.Created_At,
    ...
    const [courseRows]: any = await pool.execute(
      `SELECT C.Title, C.Reward_Skill, P.Completed_At, C.Reward_RP
    ...
    // Restored B.Completed_At to keep your dates intact
